...
const TemplateInputSelect = ({children, label, typeInput, valeurUpdate, valeurEnUpdate, attributUpdate, setAttributUpdate, urlAPI, attributEnUpdate, setAttributEnUpdate}) => {
    const {infoSku,entretienUpdate, setEntretienUpdate, entretienEnUpdate, setEntretienEnUpdate,
        ...
        filtreUpdate, filtreEnUpdate, setFiltreUpdate, setFiltreEnUpdate,} = useContext(FormContext)  
...
const handleChange = (motcle) => {
    ...
    return (
        ...
        <div>
            ...
            {showList && valeurUpdate != attributUpdate && 
