...
const Matiere = () => {
    ...
    const {infoSku, totalMatiere} = useContext(FormContext)
    const {
...
export const MatiereItem = ({item, matiere, setMatiere, pourcentMatiere, setPourcentMatiere, matiereList={matiereList}}) => {
    const {setTotalMatiere, totalMatiere} = useContext(FormContext)
    const {pourcentMatiere1Update, pourcentMatiere2Update, pourcentMatiere3Update, pourcentMatiere4Update, pourcentMatiere5Update, pourcentMatiere6Update, pourcentMatiere7Update, pourcentMatiere8Update, pourcentMatiere9Update, pourcentMatiere10Update} = useContext(FormContext)

    return (
        <section className='matiere_pourcentage'>
        <div>
