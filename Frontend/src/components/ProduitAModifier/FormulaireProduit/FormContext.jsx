...
const FormContextProvider = ({children, sku}) => {
    //variable
    ...
    const [successUpdates, setSuccessUpdates] = useState()
    const [echecUpdates, setEchecUpdates] = useState()
    ...
    return (
        <FormContext.Provider value={{
            ...
            successUpdates: successUpdates, setSuccessUpdates: setSuccessUpdates,
            echecUpdates: echecUpdates, setEchecUpdates: setEchecUpdates,
